...
class GetPreferenceCenterV1ByPreferenceCenterExternalIDUrlByUserIDTooManyRequestsException extends TooManyRequestsException
{
    /**
    ...
    {
        parent::__construct('429 Rate Limited');
        $this->error = $error;
