...
class CanvasTriggerScheduleUpdatePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Braze\Model\CanvasTriggerScheduleUpdatePostBody::class;
    }

    public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Braze\Model\CanvasTriggerScheduleUpdatePostBody::class;
    }
    ...
    public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('schedule', $data)) {
            $object->setSchedule($this->denormalizer->denormalize($data['schedule'], \Braze\Model\CanvasTriggerScheduleUpdatePostBodySchedule::class, 'json', $context));
            unset($data['schedule']);
        }
    ...
    {
        return [\Braze\Model\CanvasTriggerScheduleUpdatePostBody::class => false];
    }
}
