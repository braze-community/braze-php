...
class UsersExternalIdsRenamePostBodyExternalIdRenamesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        $data = [];
        if ($object->isInitialized('currentExternalId') && null !== $object->getCurrentExternalId()) {
            $data['current_external_id'] = $object->getCurrentExternalId();
        }
        if ($object->isInitialized('newExternalId') && null !== $object->getNewExternalId()) {
            $data['new_external_id'] = $object->getNewExternalId();
        }
    ...
    {
        return ['Braze\\Model\\UsersExternalIdsRenamePostBodyExternalIdRenamesItem' => false];
    }
}
