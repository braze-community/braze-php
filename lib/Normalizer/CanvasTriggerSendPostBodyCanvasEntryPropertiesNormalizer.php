...
class CanvasTriggerSendPostBodyCanvasEntryPropertiesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Braze\Model\CanvasTriggerSendPostBodyCanvasEntryProperties();
        if (\array_key_exists('product_price', $data) && \is_int($data['product_price'])) {
        ...
        if (\array_key_exists('product_price', $data)) {
            $object->setProductPrice($data['product_price']);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('productName') && null !== $data->getProductName()) {
            $dataArray['product_name'] = $data->getProductName();
        }
        if ($data->isInitialized('productPrice') && null !== $data->getProductPrice()) {
            $dataArray['product_price'] = $data->getProductPrice();
        }
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
