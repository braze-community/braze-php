...
class UsersExternalIdsRenamePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Braze\Model\UsersExternalIdsRenamePostBody();
    ...
    {
        $data = [];
        if ($object->isInitialized('externalIdRenames') && null !== $object->getExternalIdRenames()) {
            $values = [];
            foreach ($object->getExternalIdRenames() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }
            $data['external_id_renames'] = $values;
        }
