...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class UsersExportIdsPostBodyUserAliasesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Braze\\Model\\UsersExportIdsPostBodyUserAliasesItem';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'Braze\\Model\\UsersExportIdsPostBodyUserAliasesItem';
        }
        ...
        {
            return ['Braze\\Model\\UsersExportIdsPostBodyUserAliasesItem' => false];
        }
    }
} else {
    class UsersExportIdsPostBodyUserAliasesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
