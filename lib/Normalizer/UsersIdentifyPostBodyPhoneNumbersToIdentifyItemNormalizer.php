...
class UsersIdentifyPostBodyPhoneNumbersToIdentifyItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Braze\Model\UsersIdentifyPostBodyPhoneNumbersToIdentifyItem::class;
    }

    public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Braze\Model\UsersIdentifyPostBodyPhoneNumbersToIdentifyItem::class;
    }
    ...
    public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Braze\Model\UsersIdentifyPostBodyPhoneNumbersToIdentifyItem();
    ...
    {
        return [\Braze\Model\UsersIdentifyPostBodyPhoneNumbersToIdentifyItem::class => false];
    }
}
