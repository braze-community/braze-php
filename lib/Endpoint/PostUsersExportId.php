...
class PostUsersExportId extends \Braze\Runtime\Client\BaseEndpoint implements \Braze\Runtime\Client\Endpoint
{
    ...
    {
        if ($this->body instanceof \Braze\Model\UsersExportIdsPostBody) {
